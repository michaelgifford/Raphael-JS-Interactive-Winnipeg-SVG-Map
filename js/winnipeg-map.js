...
for(var i = 0; i < neighbourhoods.length; i++){ // Iterate through naighbourhoods array of paths
	...
	if(neighbourhoods[i].data('id') == 'Charleswood') { // If path from neighbourhoods array's id is charleswood
		neighbourhoods[i].setAttribute('fill', 'black'); // Fill with black
	}

	neighbourhoods[i].mouseover(function(e) { // Display neighbourhood name and fade on mouseover
		this.node.style.opacity = 0.7;
		document.getElementById('neighbourhood-name').innerHTML = this.data('name');
	});
